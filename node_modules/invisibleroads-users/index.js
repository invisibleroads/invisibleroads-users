(function() {
  ...
  var $enter_user_button = $enter_user_form.find('button');

  $('.enter').mouseenter(function() {
    $enter_user_button.addClass('btn-primary').removeClass('btn-default');
  }).mouseleave(function() {
    $enter_user_button.addClass('btn-default').removeClass('btn-primary');
  }).click(function() {

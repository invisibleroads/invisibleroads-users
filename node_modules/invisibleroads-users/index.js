(function() {
  ...
  var $enter_user_button = $enter_user_form.find('[type=submit]');

  $('.enter').mouseenter(function() {
    $enter_user_button.addClass('btn-success').removeClass('btn-default');
  }).mouseleave(function() {
    $enter_user_button.addClass('btn-default').removeClass('btn-success');
  }).click(function() {
    if (user_id) {
